            ...
            <div className="w-full lg:w-1/2 mt-2">
              <CardHeader>
                <CardTitle className="text-teal pb-1 mt-0 text-lg text-center">
                  What &apos; s Included In Our Cloth Treatments Service
                </CardTitle>
                <div className="flex justify-center space-x-8 pb-4 font-bold">
                  <div className="flex flex-col items-center text-teal">
                    <CardDescription className='leading-tight text-sm'>Stain</CardDescription>
                    <CardDescription className='leading-tight text-sm'>Treatment</CardDescription>
                    <TbBoxModel2 size={24} />
                  </div>
                  <div className="flex flex-col items-center text-teal">
                    <CardDescription className='leading-tight text-sm'>Odor</CardDescription>
                    <CardDescription className='leading-tight text-sm'>Elimination</CardDescription>
                    <TbBoxModel2 size={24} />
                  </div>
                  <div className="flex flex-col items-center text-teal">
                    <CardDescription className='leading-tight text-sm'>Anti-Fade</CardDescription>
                    <CardDescription className='leading-tight text-sm'>Treatment</CardDescription>
                    <TbBoxModel2 size={24} />
                  </div>
                </div>
