              ...
              <CardHeader>
                ...
                <div className="flex justify-center space-x-8 pb-4 font-bold">
                  <div className="flex flex-col items-center text-teal">
                    <CardDescription className='leading-tight text-xs'>Garment</CardDescription>
                    <CardDescription className='leading-tight text-xs'>Steaming</CardDescription>
                    <TbBoxModel2 size={24} />
                  </div>
                  <div className="flex flex-col items-center text-teal">
                    <CardDescription className='leading-tight text-xs'>Leather & Suede</CardDescription>
                    <CardDescription className='leading-tight text-xs'>Cleaning</CardDescription>
                    <TbBoxModel2 size={24} />
                  </div>
                  <div className="flex flex-col items-center text-teal">
                    <CardDescription className='leading-tight text-xs'>Water-Based Dry</CardDescription>
                    <CardDescription className='leading-tight text-xs'>Cleaning</CardDescription>
                    <TbBoxModel2 size={24} />
                  </div>
                </div>
