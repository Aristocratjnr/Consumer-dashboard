...
export default function LaundryDashboard() {
    ...
    return (
        <div className={`flex min-h-screen ${isDarkTheme ? 'bg-gray-900 text-white' : 'bg-gradient-to-r from-white to-teal-100 text-gray-900'}`}>
            {/* Sidebar */}
            ...
            <div className="ml-64 flex-1 bg-white">
                ...
                <main className="p-6 bg-transparent">
                    ...
                    <div className="mb-8">
                        ...
                        <div className="border-3 border-r border-gray-300 bg-gradient-to-r from-white to-teal-50 shadow-md mb-6 rounded-b-lg shadow-gray-600/60">
